        ...
        <div class="col bg-white p-3">
            <div class="d-flex row justify-content-between align-items-center">
                <div id="heading" class="mb-2 col-lg-6 col-12">
                    <h1>Position</h1>
                    <h3>Manage your Position here</h3>
                    <a href="{{ url('position/create') }}" class="btn btn-secondary">Tambah Position</a>
                </div>
                <div class="col-lg-4 col-12 ">
                    <div class="row">
                        <div class="col-lg-3 col-12 text-center m-1">
                            <a href="{{ route('file.download', ['filename' => 'template-position.xlsx']) }}"
            ...
            <div id="tableUsers" class="">
                <table id="positionDatatables" class="cell-border compact stripe" width="100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Name</th>
...
@section('script')
    <script>
        $(document).ready(function() {
            var table = $('#positionDatatables').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="d-flex justify-content-center">
                                                ...
                                                <a href="{{ url('/position/edit') }}/${data}" class="btn btn-sm btn-warning m-1">
                                                    Edit
                                                </a>
